...
window.alert('${msg}');
	...
	<%@ include file="../header.jsp" %>
		<div class="upicontainer">
			<div class="menu-wrap">
				<nav class="menu-top">
					<div class="profile"><img style="width:50px;height:50px;" src="http://localhost:8080/final02/img/${dto2[0].filename}" alt="프로필사진"/><span>${sessionScope.sname } 님 마이페이지</span></div>
					<div class="icon-list">

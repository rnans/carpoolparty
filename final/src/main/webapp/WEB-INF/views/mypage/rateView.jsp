...
window.onload=function(){
	 ...
	 document.getElementById("getView").style.display = "none"; 

}
function setView(){
	
	document.getElementById("setView").style.display = "block"; 
	document.getElementById("getView").style.display = "none";
}
function getView(){
	
	document.getElementById("getView").style.display = "block"; 

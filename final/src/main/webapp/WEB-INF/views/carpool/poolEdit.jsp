...
<article>
<div>
<form name="poolEdit" action="pooledit.do">
<h1>(타세요 / 태워주세요 태그) 카폴 수정하기</h1>
<div>프로필 사진 영역</div>
<div>출발지 <input type="text" name="startSpot" placeholder="출발지를 입력하세요."></div>
<div>경유지 <input type="text" name="route"></div>
<div>도착지 <input type="text" name="endSpot" placeholder="도착지를 입력하세요."></div>
<div>출발 일시</div>
<div>목적</div>
<div>인원</div>
<div>비용</div>

...
public class yangVerMypageDTO {
	...
	public yangVerMypageDTO() {
		super();
	}



	public yangVerMypageDTO(String id, String name, String birth, String phonenum, String addr, String email) {
		super();
		this.id = id;
		this.name = name;
		this.birth = birth;
	...
	public yangVerMypageDTO(int idx, String id, String pwd, String pwd2, String name, String birth, String phonenum,

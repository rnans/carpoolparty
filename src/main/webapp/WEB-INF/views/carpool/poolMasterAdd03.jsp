		...
		<div class="content-wrap">
			<div class="content">
				<div class="row">
					...
					<div class="row">
								...
								<div class="col-md-8">
									<div class="input input--nao col-md-12">
										<input class="input__field input__field--nao" type="text"
											id="ss" name="startspot"><br> <input
											type="hidden" id="sc" name="startcoordi"> <label
						...
						<path
									...
									<div class="input input--nao col-md-12">
										<input class="input__field input__field--nao" type="text"
											id="es" name="endspot"><br> <input type="hidden"
											id="ec" name="endcoordi"> <label
						...
						<path
									...
									<input type="hidden" id="eLat" name="eLat" /> <input
										type="hidden" id="eLng" name="eLng" />
									<div class="col-md-4">
				...
				<script>
					...
					mapOption = {
						center : new daum.maps.LatLng(37.566535,
								126.97796919999996), // 지도의 중심좌표
						level : 6, // 지도의 확대 레벨
					...
					function initAutocomplete(id) {
						...
						// 마커 이미지를 생성합니다
						var markerImg = new daum.maps.MarkerImage(imgSrc,
								imgSize, imgOption);
											...
											var callback = function(status,
												...
												if (status === daum.maps.services.Status.OK) {
													...
													if (title == '출발지') {
														...
														document
																.getElementById('ss').value = '대한민국 '
																+ result[0].jibunAddress.name;

													} else if (title == '도착지') {
														document
																.getElementById('es').value = '대한민국 '
																+ result[0].jibunAddress.name;
													}
				...
				<script>
					(function() {
						[].slice.call(
								document.querySelectorAll('select.cs-select'))
								.forEach(function(el) {
									new SelectFx(el);
								});
					})();

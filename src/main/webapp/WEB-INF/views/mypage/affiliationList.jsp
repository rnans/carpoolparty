...
<script>
function poolDel(poolname){
	
	
	var param='?poolname='+poolname; 
location.href='affiliationDel.do'+param;
}
</script>
...
var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
   ...
   <%@ include file="../header.jsp" %>
      <div class="Mycontainer">
         <div class="menu-wrap">
            <nav class="menu-top">
               <div class="profile"><img style="width:50px;height:50px;" src="http:/final02/img/${dto2[0].filename}" alt="프로필사진"/><span id="my">${sessionScope.sname} 님 마이페이지</span></div>
               <div class="icon-list">
            ...
            <table border="1" cellspacing="0" align="center" class="table table-striped" style="width: 100%; margin: 0px auto; padding-left: 10px;">
               <thead>
                  <tr>               
                     ...
                     <th style="text-align: center; font-size: 13px;">파티장 아이디</th>
                     <th style="text-align: center; font-size: 13px;">목적</th>
                    
                     <th style="text-align: center; font-size: 13px;">도착지</th>
                     
                     <th style="text-align: center; font-size: 13px;">요금</th>
                     <th style="text-align: center; font-size: 13px;">시작일</th>
                     <th style="text-align: center; font-size: 13px;">종료일</th>
                     <th style="text-align: center; font-size: 13px;">카풀탈퇴</th>
      ...
      <c:if test="${empty list}">
         ...
         <c:forEach var="dto" items="${list }">
            <tr align="center" >
               ...
               <td style="font-size: 13px;">${dto.userid}</td>

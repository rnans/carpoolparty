...
{ 
	...
	<%@ include file="../header.jsp" %>
		<div class="Mycontainer">
			<div class="menu-wrap">
				<nav class="menu-top">
					<div class="profile"><img style="width:50px;height:50px;" src="http://partypool2.azurewebsites.net/final02/img/${dto3[0].filename}" alt="프로필사진"/><span id="my">${sessionScope.sname} 님 마이페이지</span></div>
					<div class="icon-list">
